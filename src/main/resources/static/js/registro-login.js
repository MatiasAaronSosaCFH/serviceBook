...
document.getElementById("enlace-registrar").addEventListener("click", openRegisterModal);

document.getElementById("btnVolver").addEventListener("click", volverLoginModal);